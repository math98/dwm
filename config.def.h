...
static const char *fonts[]          = {"Ubuntu Mono Nerd Font:size=14:antialias=true:autohint=true","SymbolsNerdFont:size=14:antialias=true:autohint=true","NotoColorEmoji:size=14:antialias=true:autohint=true" };
...
const char *spcmd1[] = {"st", "-n", "spterm", "-g", "120x34", "-e", "ncmpc", NULL };
const char *spcmd2[] = {"st", "-n", "spfm", "-g", "144x41", "-e", "ranger", NULL };
const char *spcmd3[] = {"st", "-n", "keepassxc", "-g", "144x41", "-e", "tmux", NULL };
...
static Key keys[] = {
    ...
    { MODKEY,               XK_d,     spawn,      SHCMD("rofi -no-config -show drun")  },
    { MODKEY,               XK_f,     spawn,      SHCMD("firefox")  },
    { MODKEY,               XK_a,     spawn,      SHCMD("caja")  },
    ...
    { MODKEY|ShiftMask,             XK_F12,    spawn,      SHCMD("sysact")  },
